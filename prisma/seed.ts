...
async function main() {
  ...
  const baleiaJubarte = await prisma.tour.upsert({
    ...
    create: {
      ...
      maxCapacity: 20,
      category: 'WHALE',
      images: ['https://placehold.co/800x600/1E40AF/FFFFFF?text=Baleia+Jubarte'],
      isActive: true,
      commissionRate: 0.10,
    },
  })
  ...
  const barcoEspelho = await prisma.tour.upsert({
    ...
    create: {
      ...
      maxCapacity: 16,
      category: 'BOAT',
      images: ['https://placehold.co/800x600/0891B2/FFFFFF?text=Praia+do+Espelho'],
      isActive: true,
      commissionRate: 0.10,
    },
  })
  ...
  const buggyCosta = await prisma.tour.upsert({
    ...
    create: {
      ...
      maxCapacity: 4,
      category: 'BUGGY',
      images: ['https://placehold.co/800x600/B45309/FFFFFF?text=Buggy'],
      isActive: true,
      commissionRate: 0.08,
    },
  })
  ...
  const vivencia = await prisma.tour.upsert({
    ...
    create: {
      ...
      maxCapacity: 10,
      category: 'EXPERIENCE',
      images: ['https://placehold.co/800x600/7C3AED/FFFFFF?text=Vivencia'],
      isActive: true,
      commissionRate: 0.12,
    },
  })
